...
این یک اکستنشن کروم است که به سادگی میتواند فالووهای پیج هدف در اینستاگرام را استخراج کند.
لیست فالوورها را باز کنید و هنگامی که دکمه Start Scraping را کلیک کنید، اکستنشن نام‌کاربری و لینک پروفایل فالوورها را استخراج و آن‌ها را در یک فایل ".txt" در پوشه Downloads سیستم شما ذخیره می‌کند.
...
5. منتظر بمانید تا فرآیند استخراج تکمیل شود.
